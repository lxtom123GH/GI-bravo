# AGENTS.md — working conventions for GI-bravo

<!-- Canonical agent-instructions file (the cross-tool standard). CLAUDE.md is a one-line
     shim (`@AGENTS.md`) so Claude Code keeps loading these; other agents read this directly. -->
